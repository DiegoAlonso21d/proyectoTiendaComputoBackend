...
@NamedQuery(name = "Usuario.getAllUser",query = "select new com.ventas.comput.wrapper.UsuarioWrapper(u.id,u.nombres,u.email,u.telefono,u.estado,u.role) from Usuario u")
